...
class Profile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Profile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'deedee.api.profile.model'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'referredBy', protoName: 'referredBy')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'username')
    ..pc<$0.Contact>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contacts', $pb.PbFieldType.PM, subBuilder: $0.Contact.create)
    ..e<Profile_Status>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: Profile_Status.ACTIVE, valueOf: Profile_Status.valueOf, enumValues: Profile_Status.values)
  ...
  @$pb.TagNumber(3)
  $core.String get referredBy => $_getSZ(2);
  @$pb.TagNumber(3)
  set referredBy($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasReferredBy() => $_has(2);
  @$pb.TagNumber(3)
  void clearReferredBy() => clearField(3);
  ...
  @$pb.TagNumber(5)
  $core.List<$0.Contact> get contacts => $_getList(4);

  @$pb.TagNumber(6)
  Profile_Status get status => $_getN(5);
  @$pb.TagNumber(6)
  set status(Profile_Status v) { setField(6, v); }
  @$pb.TagNumber(6)
