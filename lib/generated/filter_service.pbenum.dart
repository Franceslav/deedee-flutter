...
class CompositeFilter_Status extends $pb.ProtobufEnum {
  static const CompositeFilter_Status BOOKMARKED = CompositeFilter_Status._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BOOKMARKED');
  static const CompositeFilter_Status SUBSCRIBED = CompositeFilter_Status._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SUBSCRIBED');
