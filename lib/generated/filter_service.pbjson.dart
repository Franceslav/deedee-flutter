...
const FilterRequest$json = const {
  '1': 'FilterRequest',
  '2': const [
    const {'1': 'filter', '3': 1, '4': 1, '5': 11, '6': '.bucket.Filter', '10': 'filter'},
  ],
};

/// Descriptor for `FilterRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List filterRequestDescriptor = $convert.base64Decode('Cg1GaWx0ZXJSZXF1ZXN0EiYKBmZpbHRlchgBIAEoCzIOLmJ1Y2tldC5GaWx0ZXJSBmZpbHRlcg==');
...
final $typed_data.Uint8List filterResponseDescriptor = $convert.base64Decode('Cg5GaWx0ZXJSZXNwb25zZRImCgZmaWx0ZXIYASABKAsyDi5idWNrZXQuRmlsdGVyUgZmaWx0ZXI=');
...
const Filter$json = const {
  ...
  '2': const [
    ...
    const {'1': 'filterKeys', '3': 5, '4': 3, '5': 11, '6': '.bucket.FilterKey', '10': 'filterKeys'},
...
final $typed_data.Uint8List filterDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List filterKeyDescriptor = $convert.base64Decode('CglGaWx0ZXJLZXkSGAoHdG9waWNJZBgBIAEoCVIHdG9waWNJZBIUCgV0aXRsZRgCIAEoCVIFdGl0bGU=');
...
const GetFilterKeysResponse$json = const {
  ...
  '2': const [
    const {'1': 'filterKeys', '3': 1, '4': 3, '5': 11, '6': '.bucket.FilterKey', '10': 'filterKeys'},
  ],
};

/// Descriptor for `GetFilterKeysResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getFilterKeysResponseDescriptor = $convert.base64Decode('ChVHZXRGaWx0ZXJLZXlzUmVzcG9uc2USMQoKZmlsdGVyS2V5cxgBIAMoCzIRLmJ1Y2tldC5GaWx0ZXJLZXlSCmZpbHRlcktleXM=');
