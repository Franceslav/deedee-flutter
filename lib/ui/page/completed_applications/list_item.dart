...
import 'package:deedee/ui/page/completed_applications/completed_applications_detail.dart';
import 'package:deedee/ui/routes/app_router.gr.dart';
import 'package:deedee/ui/theme/app_text_theme.dart';
import 'package:flutter/material.dart';
import 'package:flutter_slidable/flutter_slidable.dart';

class CompletedApplicationsListItem extends StatelessWidget {
  final ServiceRequest request;
  final SlidableActionCallback onAccept;
  final SlidableActionCallback onDismissed;
  const CompletedApplicationsListItem(
      {Key? key,
              ...
              case ServiceRequest_Status.DECLINED:
                {
                  showDialog(
                      context: context,
                      builder: (_) =>
                          Dialog(child: CompletedApplicationsDetail(request: request)));
                }
                break;
