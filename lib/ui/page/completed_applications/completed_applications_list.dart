...
class CompletedApplicationsList extends StatefulWidget {
  ...
  @override
  State<CompletedApplicationsList> createState() => _CompletedApplicationsListState();
}

class _CompletedApplicationsListState extends State<CompletedApplicationsList> {
  @override
    ...
    return requests.isEmpty
        ...
        : ListView.separated(
            ...
            itemBuilder: ((context, index) {
              ...
              return CompletedApplicationsListItem(
                request: request,
                onAccept: (_) {
